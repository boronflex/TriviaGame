$(document).ready(function() {
	...
	var gameLogic = {
		...
		questionBank: [
			...
			{question: "Who is NOT a current member of Toto?",
			answers: ["Boz Scaggs","Steve Lukather","David Paich","Steve Porcaro"]},

			{question: "How albums have Toto released?",
			answers: ["17","13","10","25"]},

			{question: "What David Lynch movie did Toto compose music for?",
			answers: ["Dune","Blue Velvet","Eraserhead","Mulholland Drive"]},

			{question: "Which Rosanna was the song by the same name rumored to be about",
			answers: ["Arquette","Smith","Jones","Barr"]},

			{question:  "Where are the orginal band members mostly from?",
			answers: ["Van Nuys, CA","Los Angeles, CA","San Diego, CA","San Francisco, CA"]},

			{question: "Which song from Michael Jackson's Thriller was co-written by Steve Porcaro?", 
			answers: ["Human Nature","Thriller","Wanna Be Startin' Somethin'","Billie Jean"]},

			{question: "Which Toto Album Won an Album of the Year Grammy?",
			answers: ["TotoIV","Toto","Hydra","Isolation"]},

			{question: "What George Lucas movie inspired the Toto song '99'?",
			answers: ["THX 1138","Star Wars","Howard The Duck","American Graffiti"]},

			{question: "What postion did 'Hold the Line' peak at on the Billboard Hot 100 Chart?",
			answers: ["5","10","1","25"]}
		],
	...
	var handler = {
		...
		getAnswer: function  (){
			...
			$(".answer-button").click(function(){
				...
				rightAnswer = gameLogic.questionBank[gameLogic.currentQuestion].answers[0];//gameLogic.currentQuestion
